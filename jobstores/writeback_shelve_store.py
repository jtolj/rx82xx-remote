...
Modified to use writeback and flush to disk on each change.
"""
...
class WriteBackShelveJobStore(JobStore):
    MAX_ID = 1000000
    ...
    def __init__(self, path, pickle_protocol=pickle.HIGHEST_PROTOCOL):
        ...
        self.store = shelve.open(path, 'c', self.pickle_protocol, True)
